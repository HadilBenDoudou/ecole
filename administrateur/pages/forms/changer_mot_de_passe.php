                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tables">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table.php?idUser=<?php echo $idUser ?>#services">les comptes professeurs</a></li>
                            </ul>
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table.php?idUser=<?php echo $idUser ?>#etudiant">les comptes etudiants</a></li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php echo $msg; ?>
                                    <form action="changer_mot_de_passe.php?idUser=<?php echo $idUser; ?>" method="post">
