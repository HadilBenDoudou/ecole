                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        try {
                            ...
                            $club_query = "SELECT DISTINCT club_id, club_name FROM club";
                            ...
                            while ($club_row = $club_stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <div class='card-header bg-primary text-white'>
                                    <h3 class='card-title'>{$club_row['club_name']}</h3>
                                </div>
                                <div class='card-body'>
                                ...
                                // Requête SQL pour récupérer les membres du club spécifié
                                $membre_query = "SELECT nom, prenom, carte_etudiant, classe
                                    FROM clubmembre
                                    WHERE club_id = {$club_row['club_id']}";

                                // Exécution de la requête pour récupérer les membres du club
