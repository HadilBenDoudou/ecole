          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="pages/forms/loginp.php?idUser=<?php echo $idUser ?>">Mon compte</a>
                </li>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome administrateur</h3>
                ...
                <div class="card-people mt-auto">
                  ...
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        <h4 class="location font-weight-normal">Kelibia</h4>
                ...
                ?>
                          ...
                          <div class="card-body">
                            ...
                            <p class="fs-30 mb-2">
                              ...
                              try {
                                ...
                                $sql = "SELECT COUNT(*) as student_count FROM etudiant";
                                $stmt = $pdo->query($sql);
                                $count = $stmt->fetch(PDO::FETCH_ASSOC)['student_count'];

                                echo $count; // Output the count of students
                      ...
                      <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-light-danger">
                          <div class="card-body">
                            <p class="mb-4">Your professeur</p>
                            <p class="fs-30 mb-2">
                              <?php
                              try {
                                $pdo = new PDO('mysql:host=localhost;dbname=ecole', 'root', '');
                                ...
                                // Query to count the number of professors
                                $sql = "SELECT COUNT(*) as professor_count FROM utilisateur WHERE role = 'professeur'";
                                $stmt = $pdo->query($sql);
                                $count = $stmt->fetch(PDO::FETCH_ASSOC)['professor_count'];

                                echo $count; // Output the count of professors
                              } catch (PDOException $e) {
                                echo "Error: " . $e->getMessage();
                              }
                              ?>
