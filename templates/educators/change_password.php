            ...
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <ul>
                        ...
                        <li><a class="active">My Compte</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contant-block">
                            ...
                            <form id="contact" method="post" action="updatePwd.php">
                                <h2 class="text-center"> Compte :<?php echo $_SESSION['user']['login'] ?> </h2>

                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <input class="form-control" type="password" name="oldpwd" autocomplete="new-password" placeholder="Taper votre Ancien Mot de passe" required />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <input class="form-control" type="password" name="newpwd" autocomplete="new-password" placeholder="Taper votre Nouveau Mot de passe" required />
                                        </div>
                                    </div>

                                    <div class="col-12 text-end">
                                        <button type="submit" class="educators-btn medium dark" id="form-submit">
                                            Submit
                                        </button>
                                    </div>
                                </div>
