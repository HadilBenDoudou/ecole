...
<body>
  ...
  <div id="main-wrapper" class="main-wrapper">
          ...
          <ul class="navbar-nav ms-auto me-auto mainmenu">
            ...
            <li class="menu-item-has-children">
              ...
              <ul class="educators-submenu multiline">
                ...
                <li>
                  <a href="blogs.php" class="active">formation</a>
                </li>
                <li>
      ...
      <div class="container">
        <div class="breadcrumb-content">
          ...
          <ul>
            ...
            <li><a class="active">formation</a></li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="blog style-1 blog-bg">
      <div class="container">
            ...
            <div class="col-xl-9 col-lg-8 col-md-7 col-12">
              <form action="blogs.php" method="GET">
                <div class="input-group form-group mb-md-0">
                  <input class="form-control" name="search" type="text" placeholder="Search Courses..." />
        ...
        <div class="row">
          ...
          try {
            ...
            if (isset($_GET['search']) && !empty($_GET['search'])) {
              $search = '%' . $_GET['search'] . '%';
              $sql .= " WHERE nom_formation LIKE :search OR description LIKE :search";
            }

            $stmtFormations = $connexion->prepare($sql);

            // Lier les paramètres de recherche si nécessaire
            if (isset($search)) {
              $stmtFormations->bindParam(':search', $search);
            }
          ...
          ?>
              <div class="col-xl-4 col-md-6 col-12">
                <div class="blog-block space">
                  ...
                  <span><?php echo $formation['date_debut']; ?> - <?php echo $formation['responsable_formation']; ?></span>
                  <h4><?php echo $formation['nom_formation']; ?></h4>
                  <p><?php echo $formation['description']; ?></p>
                  <a href="formation-detail.php?formation_id=<?php echo $formation['formation_id']; ?>" class="educators-btn medium dark">Read More</a>
                </div>
              </div>
          <?php
            endforeach;
