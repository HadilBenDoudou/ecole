          ...
          <ul class="navbar-nav ms-auto me-auto mainmenu">
            ...
            <li class="menu-item-has-children">
              ...
              <ul class="educators-submenu multiline">
                ...
                <li>
                  <a href="gallery-2.php" class="active">Gallery 2</a>
                </li>
    ...
    <section class="gallery style-2">
      <div class="container">
        <div class="heading">
          ...
          <p>
            It's time to showcase your photography skills in our University
          </p>
        </div>
        <div class="gallery-wrapper">
          <div>
            <img src="assets/media/gallery/gallery-2/image1.jpg" alt="" />
          </div>
          <div class="tall">
            <img src="assets/media/gallery/gallery-2/image2.jpg" alt="" />
          </div>
          <div class="wide">
            <img src="assets/media/gallery/gallery-2/image3.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image4.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image5.jpg" alt="" />
          </div>
          <div class="tall">
            <img src="assets/media/gallery/gallery-2/image6.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image7.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image8.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image9.jpg" alt="" />
          </div>
          <div class="wide">
            <img src="assets/media/gallery/gallery-2/image10.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image11.jpg" alt="" />
          </div>
          <div>
            <img src="assets/media/gallery/gallery-2/image12.jpg" alt="" />
          </div>
        </div>
      </div>
    </section>
