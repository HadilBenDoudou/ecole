...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial -->
      <div class="main-panel" id="charts">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Envoyer message collective
                  </p>
                  <?php
                  if (isset($_GET['mail']) && !empty($_GET['mail'])) {
                    // Afficher le message de succès pour l'ajout d'une annonce
                    echo '<div class="alert alert-success">' . htmlspecialchars($_GET['mail']) . '</div>';
                  }
                  ?>
                  <form class="forms-sample" action="envoyer_email_collectif.php<?php echo isset($_GET['idUser']) ? '?idUser=' . $_GET['idUser'] : ''; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="message" class="form-control" name="message" rows="4" cols="50" placeholder="Message" required></textarea>
                    </div>
                    <div class="form-group">
                  ...
                  <?php if (isset($_GET['success']) && $_GET['success'] == 'true') : ?>
                    <script>
                      alert('Email envoyé à tous les destinataires.');
                    </script>
                  <?php endif; ?>
                </div>
              </div>
