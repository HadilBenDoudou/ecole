                        ...
                        <table class="table custom-table">
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    // ID de l'utilisateur pour lequel vous souhaitez afficher les emplois
                                    $id_utilisateur =  isset($_GET['idUser']) ? $_GET['idUser'] : null;; // Remplacez 123 par l'ID de l'utilisateur souhaité

                                    // Requête SQL pour récupérer les emplois du professeur associé à l'utilisateur
                                    $sql = "SELECT emplois_professeur.ID, emplois_professeur.Description, emplois_professeur.Classe, emplois_professeur.Image_file
            FROM emplois_professeur
            JOIN utilisateur ON emplois_professeur.Nom_professeur = utilisateur.carte_professeur
            WHERE utilisateur.idUser = :id_utilisateur";
                                    ...
                                    if ($requete->rowCount() > 0) {
                                        ...
                                        while ($row = $requete->fetch(PDO::FETCH_ASSOC)) {
                                            echo "<tr>";
                                            echo "<td><a href='../../../administrateur/pages/forms/" . $row["Image_file"] . "' >Telecharger emploi</a>";
                                        ...
                                        echo "<tr><td colspan='3'>Aucun emploi trouvé pour cet utilisateur.</td></tr>";
                                    }
