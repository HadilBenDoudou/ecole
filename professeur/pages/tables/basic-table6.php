                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    $username = "root";
                                    $password = "";
                                    $database = "ecole"; // Remplacez "votre_base_de_donnees" par le nom de votre base de données
                                    ...
                                    ?>
                                                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" style="background-color: white;">
                                                        <form action="updateUtilisateur3.php" method="post" class="forms-sample" style="padding-top: 100px;">

                                                            <div class="form-group">
                                                                <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                                <label for="name">Login</label>
                                                                <input type="text" id="login" name="login" value="<?php echo $login; ?>" class="form-control" required><br>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input_box">
                                                                    ...
                                                                    <input type="email" id="email" name="email" value="<?php echo $email; ?>" class="form-control" required><br><br>
                                                                </div>
                                                            </div>
                                                            <div class="text-center"><button type="submit" class="btn btn-primary" style="background-color: #149ddd;">Enregistrer</button></div>
                                                            <a href="../../pages/tables/basic-table7.php?idUser=<?php echo $idUser ?>">Modifier le mot de passe</a>
