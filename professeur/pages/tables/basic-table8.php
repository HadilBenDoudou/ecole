        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <style>
                ...
                th {
                    ...
                    /* Bleu clair plus foncé pour les en-têtes */
                }

                tr:nth-child(even) {
                    background-color: #ebf3fb;
                    /* Bleu clair plus foncé pour les lignes paires */
                }
            </style>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    try {
                                        ...
                                        // Requête SQL
                                        $sql = "SELECT nom_formation, 
                                        (SELECT nom FROM formationmembre WHERE formation_id = formations.formation_id) AS nom,
                                        (SELECT prenom FROM formationmembre WHERE formation_id = formations.formation_id ) AS prenom
                                        FROM formations
                                        WHERE responsable_formation = (
                                            SELECT id 
                                            FROM professeur 
                                            WHERE carte_professeur = (
                                                SELECT carte_professeur 
                                                FROM utilisateur 
                                                WHERE iduser = :idUser
                                            )
                                        )";
                                        ...
                                        // Liaison de la valeur de l'id de l'utilisateur
                                        ...
                                        if ($stmt->rowCount() > 0) {
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                echo "<h3>{$row["nom_formation"]}</h3>"; // Affichage du nom de la formation
                                                echo "<table class='table'>";
                                                echo "<thead><tr><th>Nom du membre</th><th>Prénom du membre</th></tr></thead>";
                                                echo "<tbody>";
                                                echo "<tr>";
                                                echo "<td>" . $row["nom"] . "</td>"; // Affichage du nom du membre
                                                echo "<td>" . $row["prenom"] . "</td>"; // Affichage du prénom du membre
                                                echo "</tr>";
                                                echo "</tbody>";
                                                echo "</table>";
                                            }
