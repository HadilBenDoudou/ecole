                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card" style="width: 200px;">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Ajouter les cours</h4>
                                        ...
                                        if ($userRow) {
                                            ...
                                            if ($stmt_professeurs->rowCount() > 0) {
                                                ...
                                                if ($matieres) {
                                                    ...
                                                    if (isset($_GET['matiere26']) && !empty($_GET['matiere26'])) {
                                                        // Afficher le message de succès pour l'ajout d'une annonce
                                                        echo '<div class="alert alert-success">' . htmlspecialchars($_GET['matiere26']) . '</div>';
                                                    }

                                                    echo "<form class='forms-sample' action='upload_cours.php?idUser=$idUser' method='post' enctype='multipart/form-data'>";
                                                    ...
                                                    echo "</div>";
                                                    echo "<label for='exampleInputEmail1'>Titre du cours :</label>";
                                                    ...
                                                    echo "<br>";
                                                    echo "<label for='exampleInputEmail1'>Ajouter un cours :</label>";
                            ...
                            <div class="card" style="background-color: #F5F7FF;">
                                ...
                                <div class="card-body" style="width: 1000px;">
                                    ...
                                    <table class="table custom-table">
                                        <?php
                                        if (isset($_GET['cour25']) && !empty($_GET['cour25'])) {
                                            // Afficher le message de succès pour l'ajout d'une annonce
                                            echo '<div class="alert alert-success">' . htmlspecialchars($_GET['cour25']) . '</div>';
                                        }
                                        ?>
                                        <?php
                                        // Connexion à la base de données avec PDO
                                        ...
                                        $username = "root";
                                        $password = "";
                                        $dbname = "ecole"; // Remplacez "votre_base_de_données" par le nom de votre base de données
                                        try {
                                            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                            ...
                                            $requete_cours_utilisateur = "SELECT * FROM cour WHERE ProfesseurID = :idUser";
                                            ...
                                            // Vérifier s'il y a des enregistrements à afficher
                                            if ($stmt_cours_utilisateur->rowCount() > 0) {
                                                // Commencer à afficher le tableau HTML
                                                ...
                                                while ($row = $stmt_cours_utilisateur->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    echo "<a href='supprimerc.php?id={$row['ID']}&idUser={$idUser}' onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer cette matière ?');\">Supprimer</a>";
                                                    ...
                                                    echo "<form action='modifierc.php?idUser=" . $idUser . "' method='post' enctype='multipart/form-data'>";
                                                ...
                                                echo "<tr><td colspan='7'>Aucun enregistrement trouvé dans la table 'cour' pour cet utilisateur.</td></tr>";
                                            }
                                        } catch (PDOException $e) {
                                            echo "Erreur : " . $e->getMessage();
                                        }
